...
export default function IntroHeading({ title, subText }) {
  return (
    <div className="flex flex-col md:flex-row md:justify-between md:items-end gap-6">
      ...
      <button className="w-full md:w-auto px-6 py-3 bg-primary text-white rounded-xl text-sm font-bold hover:shadow-lg hover:shadow-primary/30 transition-all flex items-center justify-center gap-2 shrink-0  cursor-pointer ">
